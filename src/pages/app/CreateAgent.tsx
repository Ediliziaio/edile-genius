...
const STATIC_TEMPLATES: HubTemplate[] = [
  ...
  },
  {
    ...
    description: "Visualizza il restyling di facciate con cappotto termico, colori e finiture diverse. Il cliente vede subito l'effetto del cappotto e della nuova tinteggiatura.",
    icon: "🏢", category: "vendita", channel: ["visuale"], difficulty: "facile",
    estimated_setup_min: 5, installs_count: 12, is_featured: false,
    settore: "edilizia", kpi: "Conversione +25%",
    result: "→ Il condominio approva più velocemente vedendo il risultato",
  },
  {
    slug: "render-persiane", name: "Render Persiane AI",
    description: "Mostra al cliente come appariranno le nuove persiane sulla sua facciata. Stile, colore e materiale visualizzati in pochi secondi.",
    icon: "🪟", category: "vendita", channel: ["visuale"], difficulty: "facile",
    estimated_setup_min: 5, installs_count: 8, is_featured: false,
    settore: "serramenti", kpi: "Conversione +28%",
    result: "→ Il cliente sceglie modello e colore senza dubbi",
  },
  {
    slug: "render-pavimento", name: "Render Pavimento AI",
    description: "Trasforma una foto del pavimento esistente in un render con la nuova pavimentazione. Piastrelle, parquet, resina: il cliente vede tutto prima di decidere.",
    icon: "🏗️", category: "vendita", channel: ["visuale"], difficulty: "facile",
    estimated_setup_min: 5, installs_count: 6, is_featured: false,
    settore: "ristrutturazioni", kpi: "Conversione +30%",
    result: "→ Il cliente confronta materiali e decide subito",
  },
  {
    slug: "render-stanza", name: "Render Stanza AI",
    description: "Rinnova qualsiasi stanza con un render fotorealistico: mobili, colori, luci. Il cliente vede la trasformazione completa prima di iniziare i lavori.",
    icon: "🛋️", category: "vendita", channel: ["visuale"], difficulty: "facile",
