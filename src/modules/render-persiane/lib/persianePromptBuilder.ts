// ════════════════════════════════════════════════════════════════
// Render Persiane — Prompt Builder v1.0
// ════════════════════════════════════════════════════════════════

export const PERSIANE_PROMPT_VERSION = "1.0.0";
...
export type MaterialePersiana = "legno" | "alluminio" | "pvc" | "acciaio" | "ferro_battuto" | "composito";
...
const TIPO_PERSIANA_PROMPTS: Record<TipoPersoniana, string> = {
  ...
  veneziana_esterna: "external Venetian blinds — horizontal aluminum/wood slats, external mounting",
  ...
  gelosia: "fixed-louver shutters (gelosie) — angled slats that do not move, permanent ventilation",
...
const MATERIALE_PROMPTS: Record<MaterialePersiana, string> = {
  ...
  pvc: "PVC/uPVC with smooth matte surface",
